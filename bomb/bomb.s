...
0000000000400efc <phase_2>:
  ...
  400f02:	48 89 e6             	mov    %rsp,%rsi #0x7fff8bc017d0 
...
000000000040100c <phase_4>:
  40100c:	48 83 ec 18          	sub    $0x18,%rsp # 16+8=24
...
0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx                   # restore
  401063:	48 83 ec 20          	sub    $0x20,%rsp             # stack 2 * 16       32 bytes  
  401067:	48 89 fb             	mov    %rdi,%rbx              # arg1 -> rbx
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax          # data vid
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)        # stack[3] = rax = %fs:0x28 (最后一个qword)
  401078:	31 c0                	xor    %eax,%eax              # clear
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>
  40107f:	83 f8 06             	cmp    $0x6,%eax
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx     # ecx = byte(rbx+rax) = byte(rbx)
  40108f:	88 0c 24             	mov    %cl,(%rsp)             # byte to stack[0] （第一个 0~8
  401092:	48 8b 14 24          	mov    (%rsp),%rdx            # rdx = byte[0]
  401096:	83 e2 0f             	and    $0xf,%edx              # 后四位
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)  # stack[2] = byte[0] (16~17)（17～18）
  4010a4:	48 83 c0 01          	add    $0x1,%rax              # rax ++;
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax              # for（ rax < 6 )
  ...
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax              # jump from 401082 if input length==6
...
00000000004010f4 <phase_6>:
  ...
  ;load node[a[0]] ~ node[a[5]] address in stack
...
0000000000401242 <secret_phase>:
  ...
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax            ;input an address
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax                ;less than -3e8
...
000000000040145c <read_six_numbers>:
  ...
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8     # 4 8 10 12 20
